...
import { CreatePurchaseorder } from '@/types/purchaseorder';
...
const initFormikValue: CreatePurchaseorder = {
  isNewCustomer: false,
  customerId: '',
  customerName: '',
  customerPhoneNumber: '',
...
const New: NextPage<Props> = () => {
  ...
  return (
    <>
      <Head>
        <title>{process.env.APP_NAME + ' - New Purchaseorder'}</title>
      </Head>
      <div className='p-4'>
        <Breadcrumb
          links={[
        ...
        <div className='bg-white mb-4 p-4 rounded shadow'>
          <div className='mb-4'>
            <div className='text-xl'>New Purchaseorder</div>
          </div>
          <div>
            <Formik
