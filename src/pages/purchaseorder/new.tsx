...
import { CreateStockmovementvehiclePurcahseorder } from '@/types/stockmovementvehicle';
...
const initFormikValue: CreateStockmovementvehiclePurcahseorder = {
...
const New: NextPage<Props> = () => {
  ...
  const handleSubmit = async (values: CreateStockmovementvehiclePurcahseorder, formikHelpers: FormikHelpers<CreateStockmovementvehiclePurcahseorder>) => {
  ...
  const handleChangePurcahseorder = (e, setFieldValue) => {
    const newProduct = []
                  ...
                  <div className='bg-white mb-4 p-4 rounded shadow'>
                    ...
                    <div className="mb-2 max-w-xl">
                      <DropdownField
                        ...
                        placeholderValue={""}
                        field={true}
                        onChange={(e) => handleChangePurcahseorder(e, setFieldValue)}
                        required
                      />
                    </div>
                    {purchaseorder && (
                        ...
                        <div className=''>
                          ...
                          <div className=''>{
                            purchaseorder.stockmovements?.map((stockmovement) => {
                              return (
                                <div className='' key={stockmovement.id}>
                                  <div className=''>{stockmovement.product?.name}</div>
                                  <div className=''>{displayMoney(stockmovement.unitPrice)}</div>
                                </div>
                              )
                            })}
                          </div>
