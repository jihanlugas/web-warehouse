      ...
      <div className="mb-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="">
          ...
          <div className="text-sm">
            <div className="flex items-center mb-1">
              <FaMapMarkerAlt size={"1.2rem"} className="text-rose-500 mr-1" />
              <div className="ml-4">{data.retail?.customer?.name}</div>
            </div>
          </div>
        </div>
      </div>
...
const Index: NextPage<Props> = ({ }) => {
  ...
  const [pageRequest] = useState<PageStockmovementvehicleRetail>({
    limit: -1,
    preloads: "FromWarehouse,Product,Retail,Retail.Customer,Vehicle",
  });
              ...
              <div className="mb-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="">
                  ...
                  <div className="text-sm">
                    <div className="flex items-center mb-1">
                      <FaMapMarkerAlt size={"1.2rem"} className="text-rose-500 mr-1" />
                      <div className="ml-4">{completeData.retail?.customer?.name}</div>
                    </div>
                  </div>
                </div>
              </div>
