    ...
    <div className="page p-8 shadow">
      <div className="mb-4 grid grid-cols-3 gap-4">
        ...
        <div className="w-full text-center">
          ...
          <div className="text-3xl font-bold uppercase">Tanda Terima</div>
        </div>
      </div>
      ...
      <div className='mb-8'>
        <div className='mb-4'>Rincian Penerimaan:</div>
        <table className="w-full table-auto">
          <thead>
            <tr className="text-left border-y-3 border-gray-400">
              <th className="px-2 py-4 w-16">No</th>
              ...
              <th className='px-2 py-4'>Jumlah</th>
              <th className='px-2 py-4'>Satuan</th>
              <th className='px-2 py-4'>Selisih</th>
            </tr>
          </thead>
          <tbody>
            <tr className='border-b border-gray-400'>
      ...
      <div className='mb-8'>
        ...
        <div className='flex'>
          <div className='w-36'>Tanggal Berangkat:</div>
          <div className=' font-bold'>20 Januari 2025</div>
        </div>
        <div className='flex'>
          <div className='w-36'>Tanggal Terima:</div>
          <div className=' font-bold'>22 Januari 2025</div>
        </div>
      </div>
