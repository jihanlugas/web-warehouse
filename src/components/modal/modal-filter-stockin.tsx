...
type Props = {
  ...
  onClickOverlay: () => void;
  filter: PageStockin
  setFilter: Dispatch<SetStateAction<PageStockin>>
}

const schema = Yup.object().shape({
});

const ModalFilterStockin: NextPage<Props> = ({ show, onClickOverlay, filter, setFilter }) => {

  const [initFormikValue, setInitFormikValue] = useState<PageStockin>(filter)

  const handleSubmit = async (values: PageStockin) => {
    setFilter(values)
    onClickOverlay()
  }
...
export default ModalFilterStockin;