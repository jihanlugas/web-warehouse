...
import { UpdateStockmovementvehiclePurchaseorder } from "@/types/stockmovementvehiclepurchaseorder";
...
const ModalEditStockmovementvehiclePurchasorder: NextPage<Props> = ({ show, onClickOverlay, id }) => {
  ...
  const { mutate: mutateSubmit, isPending } = useMutation({
    mutationKey: ['stockmovementvehicle', 'purchase-order', 'update', selectedId],
    mutationFn: (val: FormikValues) => Api.put('/stockmovementvehicle/purchase-order/' + selectedId, val),
  });
