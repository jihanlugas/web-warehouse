...
export const STOCK_MOVEMENT_TYPE_TRANSFER = "TRANSFER"
export const STOCK_MOVEMENT_TYPE_IN = "IN"
export const STOCK_MOVEMENT_TYPE_PURCHASE_ORDER = "PURCHASE_ORDER"
export const STOCK_MOVEMENT_TYPE_RETAIL = "RETAIL"